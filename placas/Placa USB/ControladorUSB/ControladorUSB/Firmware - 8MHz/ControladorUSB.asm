...
;ControladorUSB.c,61 :: 		HidWriteBuff[1] = DigitalIn;
	MOVLW       2
	MOVWF       1345 
;ControladorUSB.c,62 :: 		HidWriteBuff[2] = PORTB;
	MOVF        PORTB+0, 0 
	MOVWF       1346 
...
;ControladorUSB.c,69 :: 		HidWriteBuff[1] = DigitalOut;
	MOVLW       3
	MOVWF       1345 
;ControladorUSB.c,70 :: 		HidWriteBuff[2] = PORTD;
	MOVF        PORTD+0, 0 
	MOVWF       1346 
...
;ControladorUSB.c,93 :: 		if(cmd == DigitalOut) //Saídas Digitais
	...
	BTFSS       STATUS+0, 2 
	GOTO        L_USB_Recv11
;ControladorUSB.c,95 :: 		PORTD = PORTD ^ (1 << HidReadBuff[2]);
	MOVF        1282, 0 
	MOVWF       R1 
	MOVLW       1
	MOVWF       R0 
...
;ControladorUSB.c,112 :: 		TRISB = 255;
	MOVLW       255
	MOVWF       TRISB+0 
;ControladorUSB.c,113 :: 		TRISD = 0;
	CLRF        TRISD+0 
...
;ControladorUSB.c,115 :: 		TRISC = 0;
	CLRF        TRISC+0 
;ControladorUSB.c,116 :: 		PORTD = 0xAA;
	MOVLW       170
	MOVWF       PORTD+0 
