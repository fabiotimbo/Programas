...
void setup() {
  ...
  Timer1.initialize(1000000);                    // inicializa o Timer 1
  MFS.initialize(&Timer1); 
  MFS.write("ifce");                        // escreve no display Hi
  delay(2000);  
  MFS.write("sdcd");                        // escreve no display Hi
  delay(2000);  
  MFS.userInterrupt = tempo_1s;  
}
